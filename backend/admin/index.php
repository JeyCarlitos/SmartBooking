...
<head>
        <meta charset="utf-8" />
        <title>Sistema de gestión hospitalaria: un sistema de información súper receptivo</title>
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button id="btnprimary" class="btn btn-primary btn-block" name="adminlogin" type="submit"> Admin Log In </button>
                                    </div>
